...
import { useMenuDayDiffDetailQuery } from '../../services/sales/SalesApiSlice'
import { selectCurrentDateDay } from '../../services/date/dateSlice'
import Loading from '../../component/common/Loading'
import Empty from '../../component/common/Empty'

const DayBiggestDiffDetailPages = () => {
    // 선택된 날짜 store에서 가져오기
    ...
    const { data, isLoading, error } = useMenuDayDiffDetailQuery(
...
export default DayBiggestDiffDetailPages
